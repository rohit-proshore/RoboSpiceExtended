...
import com.e.robospiceextension.request.listener.RequestCancellationListener;
...
import com.e.robospiceextension.request.listener.RequestStatus;
import com.e.robospiceextension.retry.DefaultRetryPolicy;
import com.e.robospiceextension.retry.RetryPolicy;
...
public abstract class SpiceRequest<RESULT> implements Comparable<SpiceRequest<RESULT>> {
     ...
     * @see {@link com.e.robospiceextension.networkstate.NetworkStateChecker.NetworkStateChecker}
     */
