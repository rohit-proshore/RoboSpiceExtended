package com.e.robospiceextension.request.notifier;
...
import com.e.robospiceextension.request.listener.RequestProgress;
import com.e.robospiceextension.request.listener.RequestProgressListener;
...
public interface RequestListenerNotifier {
     ...
     * {@link SpiceManager#addListenerIfPending(Class, Object, com.e.robospiceextension.request.listener.PendingRequestListener)}
     * .
     * @param request
     *            a given request.
     * @param listeners
