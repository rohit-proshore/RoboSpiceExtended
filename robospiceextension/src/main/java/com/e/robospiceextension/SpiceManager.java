...
import com.e.robospiceextension.SpiceService.SpiceServiceBinder;
import com.e.robospiceextension.command.AddSpiceServiceListenerCommand;
import com.e.robospiceextension.command.GetAllCacheKeysCommand;
import com.e.robospiceextension.command.GetAllDataFromCacheCommand;
import com.e.robospiceextension.command.GetDataFromCacheCommand;
import com.e.robospiceextension.command.GetDateOfDataInCacheCommand;
import com.e.robospiceextension.command.IsDataInCacheCommand;
import com.e.robospiceextension.command.PutDataInCacheCommand;
import com.e.robospiceextension.command.RemoveAllDataFromCacheCommand;
import com.e.robospiceextension.command.RemoveDataClassFromCacheCommand;
import com.e.robospiceextension.command.RemoveDataFromCacheCommand;
import com.e.robospiceextension.command.RemoveSpiceServiceListenerCommand;
import com.e.robospiceextension.command.SetFailOnCacheErrorCommand;
import com.e.robospiceextension.persistence.CacheManager;
import com.e.robospiceextension.persistence.DurationInMillis;
...
import com.e.robospiceextension.request.listener.PendingRequestListener;
import com.e.robospiceextension.request.listener.RequestListener;
import com.e.robospiceextension.request.listener.SpiceServiceAdapter;
...
public class SpiceManager implements Runnable {
     ...
     *            {@link RequestListener#onRequestFailure(com.e.robospiceextension.persistence.exception.SpiceException)}
     *            method.
     */
